...
\begin{itemize}
  ...
  Frontend technologies, among others, TypeScript, JavaScript, VueJS, AngularJS, NodeJS/NPM, Cypress, HTML, CSS, AJAX, WCM, Sitevision. Deploying on Sitevision.

  Native IOS/Android app development with, among others, TypeScript and NativeScript Vue.
  
  Backend development with, among others, Java, Groovy, Gradle, SpringBoot (2 to 3), Spring (3 to 6), REST, Websphere.
  ...
  Was assigned extra time to spend on tools development. Spent on, among other things, prototyping and introducing patterns. Using tools such as Nexus IQ Server (Lifecycle), Sonar, Nexus, Git, Bitbucket Server, Contract Testing with Pact, OpenAPI, Linux, OpenShift / Kubernetes, CI/CD with Jenkins, Jenkins Pipelines, PlantUML.
