...
\begin{itemize}
  ...
  Work involving: Full stack development of forsakringskassan.se, developing supporting tools and CM. Using languages like Java, Javascript, Typescript and Groovy. Using frameworks like Spring, AngularJS and VueJS.

  Was part of a team developing features in frontend and backend. Developing REST services and applications in AngularJS and VueJS.

  Was assigned extra time to spend on tools development. Spent on, among other things, prototyping and introducing patterns in Gradle, Jenkins and Node. Introduced OpenAPI and formal specifications of REST API:s along with a tool chain supporting that workflow.
